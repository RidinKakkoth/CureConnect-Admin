...
const AllAppointments = () => {
  const { getAllAppointments, appointenmts, aToken,cancelAppointment } = useContext(AdminContext);
  ...
  return (
    <div className="w-full max-w-6xl m-5">
      <p className="mb-3 text-lg font-medium">All appointenmts</p>
